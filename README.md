...
This repository contains R and Python scripts that were used to analyze the data described in the article. 
...
The repository aims to promote the **transparency**, **reproducibility** and **reusability** of machine learning workflows using Alzheimer's Disease Neuroimaging Initiative (ADNI) information.
---
